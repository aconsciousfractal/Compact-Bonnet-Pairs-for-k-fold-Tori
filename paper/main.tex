...
\item \texttt{data/full\_series\_k3\_1000.json}: all $998$ seeds.
\end{itemize}
...
The frozen commit for this paper is \texttt{2247535};
a \texttt{requirements.txt} is included in the repository.
