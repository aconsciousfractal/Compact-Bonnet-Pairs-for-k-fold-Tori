%% main.tex Ã¢â‚¬â€ Compact Bonnet Pairs: Computational Extension to 998 Seeds
...
%% Ã¢â€â‚¬Ã¢â€â‚¬ Packages Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
%% Ã¢â€â‚¬Ã¢â€â‚¬ Theorem environments (BHS style) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
\theoremstyle{plain}
...
%% Ã¢â€â‚¬Ã¢â€â‚¬ Title Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
\title{%
...
%% Ã¢â€â‚¬Ã¢â€â‚¬ Abstract Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
\begin{abstract}
Bobenko, Hoffmann, and Sageman-Furnas~\cite{BHS25} constructed
...
$998$ archived seeds satisfying the residual closing equations under the
reported mixed archive/recheck audit; additional spectral and geometric
checks are carried out on representative or separately archived subsets.
The principal finding is the mixed local-analytic/numerical
asymptotic law
\[
  \delta_k = \frac{A}{\sqrt{k}}\,\Bigl(1 - \frac{c_1}{k}
  + \Oo(k^{-2})\Bigr),
  \qquad A \approx 7.081\,416\,491\,399\,252\,576,
\]
where the local high-fold mechanism is derived analytically, the
displayed digits of~$A$ come from high-precision Richardson
extrapolation, and the computed branch is validated numerically on a
$120$-seed checkpoint set for $k\ge100$.  At $\omega_{\mathrm{crit}}$, the spectral
...
\[
  ...
  + \Oo(k^{-2}),
\]
with the leading term supported numerically on $50$ archived
...
\end{enumerate}
These conditions are Equations~(82)--(83) of~\cite{BHS25}; we
...
\item \textbf{Spectral structure.}
  We establish a local branch-point splitting mechanism, a local
  high-fold branch theorem, the large-$k$ root topology, and an exact
  local closure identity for the cross-ratio coefficient.  On the
  finite archived layer, the root topology is certified on the
  recorded seed/sweep rows by exact-rational Sturm certificates.  At
  $\omega_{\mathrm{crit}}$, the spectral
  cross-ratio satisfies $\lvert\arg(\mathrm{CR})\rvert\cdot k\to4$,
...
\subsection{Reality of the rhombic Jacobi theta data}
\label{sec:theta-reality}

The spectral coefficients defined in~\cref{sec:coeff} below are
rational expressions in the Jacobi theta constants
$\vt{j}(0|\tau)$, $\vt{j}(\omega|\tau)$, and the derivative
$\vt{1}'(0|\tau)$, all evaluated on the rhombic lattice
$\tau = \tfrac12 + \ii\lambda$ at a real critical point
$\omega \in (0,\pi/4)$. Individually these theta values are complex.
We record the elementary reality lemma that makes the Lam\'e--Riccati
coefficients $R(\omega)$, $U(\omega)$, $U'(\omega)$, $U_1'(\omega)$,
$U_2(\omega)$ real without any additional normalization choice.

Let
\begin{equation}
  p \;:=\; q^{1/4} \;=\; \ee^{\ii\pi\tau/4}
  \;=\; \ee^{\ii\pi/8}\,\ee^{-\pi\lambda/4}
  \label{eq:p-phase}
\end{equation}
denote the principal quarter-nome; its modulus is $\ee^{-\pi\lambda/4}$
and its phase is the fixed angle $\pi/8$.

\begin{lemma}[Phase factorisation of rhombic Jacobi theta values]
\label{lem:rhombic-parity}
Let $\tau = \tfrac12 + \ii\lambda$ with $\lambda > 0$ and
$q = \ee^{\ii\pi\tau}$, and let $z \in \RR$.
Writing $p = q^{1/4}$ as in~\eqref{eq:p-phase}:
\begin{enumerate}[label=(\roman*),nosep]
\item\label{item:p-factor}
  $p^{-1}\,\vt{1}(z,q) \in \RR$,
  $p^{-1}\,\vt{2}(z,q) \in \RR$, and
  $p^{-1}\,\vt{1}'(0,q) \in \RR$; equivalently, $\vt{1}$ and
  $\vt{2}$ (and the $z$-derivative of $\vt{1}$ at $0$) have constant
  argument $\pi/8$ modulo $\pi$ on the real $z$-axis.
\item\label{item:conj-swap}
  $\vt{4}(z,q) = \overline{\vt{3}(z,q)}$; in particular,
  $\vt{j}(z,q)^2 + \vt{j+1}(z,q)^2 = 2\,\Real\bigl[\vt{3}(z,q)^2\bigr] \in \RR$
  for $(j,j{+}1) = (3,4)$.
\end{enumerate}
\end{lemma}

\begin{proof}
Using the product/series expansions equivalent
to~\eqref{eq:theta1}--\eqref{eq:theta2},
\begin{align*}
  \vt{1}(z,q) &= 2\,q^{1/4}\sum_{n\ge 0}(-1)^n\,q^{n(n+1)}\sin((2n+1)z),\\
  \vt{2}(z,q) &= 2\,q^{1/4}\sum_{n\ge 0}q^{n(n+1)}\cos((2n+1)z),
\end{align*}
the overall $q^{1/4} = p$ factor is common to every nonvanishing term.
The remaining inner series involve only integer powers of $q$. For
the rhombic lattice, $q = \ii\,\ee^{-\pi\lambda}$, so
$q^{n(n+1)} = \ii^{n(n+1)}\,\ee^{-\pi n(n+1)\lambda}$. Since $n(n+1)$
is even, $\ii^{n(n+1)} = (-1)^{n(n+1)/2} \in \{\pm 1\}$. Hence the
inner sums are real for $z \in \RR$, proving~\ref{item:p-factor} for
$\vt{1}$ and $\vt{2}$. The case $\vt{1}'(0,q)$ follows by termwise
$z$-differentiation of the $\vt{1}$-series at $z=0$.

For~\ref{item:conj-swap}, substituting $q = \ii\,\ee^{-\pi\lambda}$
into $\vt{3}(z,q) = 1 + 2\sum_{n\ge 1} q^{n^2}\cos(2nz)$ and into
$\vt{4}(z,q) = 1 + 2\sum_{n\ge 1}(-1)^n q^{n^2}\cos(2nz)$ uses
$\ii^{n^2} = 1$ for $n$ even and $\ii^{n^2} = \ii$ for $n$ odd
(since $n^2 \equiv 0$ or $1 \pmod 4$). Both expansions split into
an even-$n$ block (real) and an odd-$n$ block (purely imaginary).
In $\vt{4}$ the odd-$n$ block carries an extra $-1$ from $(-1)^n$;
the even-$n$ block is unchanged. Hence
$\vt{4}(z,q) = \overline{\vt{3}(z,q)}$ for $z \in \RR$. The
stated consequence follows from $a + \bar a = 2\,\Real(a)$.
\end{proof}

\begin{proposition}[Reality of $R, U, U', U_1', U_2$ on the rhombic
lattice]\label{prop:spectral-reality}
For $\tau = \tfrac12 + \ii\lambda$ and any real $\omega \in (0,\pi/4)$,
the Lam\'e--Riccati coefficients
$R(\omega), U(\omega), U'(\omega), U_1'(\omega), U_2(\omega)$
defined by~\eqref{eq:Romega}--\eqref{eq:U2} are real. Consequently,
the cubic $Q_3$ in~\eqref{eq:Q3} and the quartic $Q$ in~\eqref{eq:Q}
have real coefficients whenever $\delta, s_1, s_2 \in \RR$ (or
$(s_1,s_2)$ is a complex-conjugate pair).
\end{proposition}

\begin{proof}
By \cref{lem:rhombic-parity}\ref{item:p-factor}, each of
$\vt{1}(z,q),\ \vt{2}(z,q),\ \vt{1}'(0,q)$ factors as $p\cdot\rho(z)$
with $\rho(z) \in \RR$. In every defining
expression~\eqref{eq:Romega}--\eqref{eq:U1prime}, the numerator and
denominator are monomials in these quantities of the \emph{same total
degree} in $\vt{1},\vt{2},\vt{1}'(0)$: $R(\omega)$ and $U_1'(\omega)$
pair degree $2$ over degree $2$, and $U'(\omega)$ pairs degree $2$
over degree $2$.  Hence the common $p$-factor cancels and the ratio
lies in $\RR$.  The identity $U(\omega) = -1/R(\omega)$ then gives
$U(\omega) \in \RR$.

For $U_2(\omega)$ the prefactor $\vt{1}'(0)^2/\vt{2}(\omega)^2$ has
net $p$-weight zero and is real by the same argument.  Of the three
bracketed summands, $\vt{1}(\omega)^2/\vt{2}(0)^2$ is also a ratio of
same-$p$-weight monomials, hence real. The remaining two summands
combine as
\[
  A + B,\qquad
  A \;=\; \frac{\vt{4}(\omega)^2}{\vt{3}(0)^2},\qquad
  B \;=\; \frac{\vt{3}(\omega)^2}{\vt{4}(0)^2},
\]
and \cref{lem:rhombic-parity}\ref{item:conj-swap} gives
$\vt{4}(\cdot) = \overline{\vt{3}(\cdot)}$ at real argument, whence
$A = \overline{B}$ and $A + B = 2\,\Real(B) \in \RR$. Combining gives
$U_2(\omega) \in \RR$. The statement for $Q_3, Q$ follows because
their coefficients in~\eqref{eq:Q3}--\eqref{eq:Q} are real polynomial
functions of the already-established real quantities and of the real
(or complex-conjugate-pair) data $\delta, s_1, s_2$.
\end{proof}

\begin{remark}[Relation to the computational pipeline]
\label{rem:real-normalization}
\Cref{prop:spectral-reality} is the mathematical content of the
``real-normalization'' used by the computational pipeline. The casts
\texttt{float(np.real(\dots))} applied in
\path{scripts/compute_constants.py} (which produces the Appendix~A
table) are legitimate once the Lam\'e--Riccati coefficients
$R, U, U', U_1', U_2$ have been formed: at that stage the imaginary
part is zero up to machine epsilon, as verified numerically at
$\abs{\Imag}/\abs{\cdot} \lesssim 10^{-16}$ on the reference lattice
$\lambda = 25/78$. The underlying reality is not a pipeline choice
but the algebraic consequence of
\cref{lem:rhombic-parity}\ref{item:p-factor} and
\cref{prop:spectral-reality}: $p$ factors cancel from every ratio of
the same total degree in $\vt{1},\vt{2},\vt{1}'(0)$, and the
$\vt{3}/\vt{4}$ terms in $U_2$ are real by conjugate-swap symmetry.
\end{remark}
...
conditions must be satisfied simultaneously.  We follow the notation of
Theorem~7 in~\cite{BHS25}.  Lemma~8 of~\cite{BHS25} reduces the
closing conditions to two real equations on $(\delta, s_2)$, and
Lemma~9 verifies local uniqueness via the non-vanishing Jacobian of the
period map.
...
paper.\footnote{Throughout this paper $s_1 = -8.5$ is a fixed real
  \emph{gauge} parameter (used to eliminate the translational freedom
  of the Riccati flow), while the symbols $s^-, s^+$ denote the two
  real roots of $Q$ bounding the oval $\mathcal V$.  The BHS convention
  $s_1^\pm$ for the same roots is not used in the body of the present
  paper; the subscript $1$ on $s_1$ always refers to the gauge.}
...
\item \textbf{Archive convention.}
  ...
  \path{results/phase15_asymptotic/full_series_k3_1000.json} is a uniform
  raw solver dump of $998$ rows: $950$ rows have residual
  $<10^{-10}$ and the remaining $48$ rows have residuals in
  $[10^{-10},\,5.35\times 10^{-10}]$; the archive-wide maximum residual
  is $5.35\times 10^{-10}$ and every row has $\texttt{nfev}\ge 8$.
\end{itemize}

\begin{remark}[Archive-level residual audit for the $998$-seed branch]
  To put the $48$ rows of the archive whose residual exceeds $10^{-10}$
  on an independent footing, we re-solve them from their archived
  ...
  All $48$ re-solves succeed.  Their returned residuals satisfy
  \[
    \max\bigl(\abs{F_{\mathrm{rat}}},\abs{F_{\mathrm{ax}}}\bigr)
    < 1.3\times 10^{-10},
  \]
  so the full $998$-seed branch is supported by a mixed archive/recheck
  residual audit at the $6\times 10^{-10}$ level.  The archive field
...
The validation framework consists of four idealized gates for a fully
uniform archive; in the checked-in $998$-seed branch file, Gate~G1 is
recorded per row, while Gates~G2--G4 are applied on representative seeds
and archived sweeps.  An additional fifth gate is used as a
representative-seed retraction audit:
...
The full series $k = 3, \ldots, 1000$ is produced by a single-threaded
run of \path{scripts/run_full_series.py} (Python~3.11,
NumPy/SciPy); wall-clock time depends on the host machine and is
dominated by the elliptic integrals in the Newton iterations.  No
parallelization or compiled code is employed.
...
\midrule
3  & $3.201588670$ & $2.506142163$ & $8.3 \times 10^{-12}$ & 120 \\
4  & $2.924732426$ & $3.277404492$ & $3.1 \times 10^{-12}$ & 90 \\
5  & $2.707932982$ & $3.847434121$ & $1.4 \times 10^{-11}$ & 72 \\
6  & $2.532186462$ & $4.281550094$ & $5.1 \times 10^{-12}$ & 60 \\
7  & $2.386167633$ & $4.621565278$ & $2.3 \times 10^{-11}$ & 51.43 \\
8  & $2.262463448$ & $4.894397705$ & $1.2 \times 10^{-11}$ & 45 \\
9  & $2.155984937$ & $5.117845227$ & $7.1 \times 10^{-13}$ & 40 \\
10 & $2.063114437$ & $5.304037890$ & $6.6 \times 10^{-12}$ & 36 \\
\bottomrule
\end{tabular}
\end{table}
...
solution on the tracked branch.
No bifurcations, branch jumps, or
failures are detected in the archived $k = 3,\ldots,1000$
continuation.  Concretely, the following numerical non-bifurcation
criteria hold uniformly on the archived series:
\begin{enumerate}[label=\upshape(\roman*),nosep]
\item \emph{Monotone decay.}  $\delta_{k+1} < \delta_k$ for every
  $k\in\{3,\ldots,999\}$; no sign change or local minimum is observed.
\item \emph{Uniform Newton success.}  Every archived row has residual
  below $5.35\times 10^{-10}$ and solver function-evaluation count
  $\texttt{nfev}\ge 8$, with no failed or restarted secant step along
  the $k\mapsto k+1$ continuation.
\item \emph{Non-degenerate Jacobian.}  The period-map Jacobian
  $\partial(F_{\mathrm{rat}},F_{\mathrm{ax}})/\partial(\delta,s_2)$ is
  numerically non-singular throughout the archived sweep (the residual
  column of \cref{tab:first-seeds} and of the final-seeds table above
  tracks this via the Newton-step control).
\end{enumerate}
These are numerical criteria rather than a rigorous proof of
branch identity (which remains open; see
\cref{rem:B2-status} in \cref{app:rigorous}).
\Cref{fig:delta-vs-k} shows $\delta_k$ versus~$k$
on a log--log scale: the data collapse onto a straight line with
slope $-0.5$, the first visual evidence for \cref{valid:asymptotic}.
...
999  & $0.22385393$ & $7.29956973$ & $2.3 \times 10^{-11}$ & $0.3604$ \\
1000 & $0.22374216$ & $7.29959337$ & $1.9 \times 10^{-11}$ & $0.3600$ \\
\bottomrule
\end{tabular}
\end{center}
\noindent
...
\begin{validatedclaim}[Computer-assisted asymptotic law on the
  computed branch]\label{valid:asymptotic}
...
\end{validatedclaim}
\begin{proof}
  See \cref{app:rigorous}: \cref{thm:local-high-fold-branch,obs:rigorous-asymp}.
...
\begin{remark}
  \Cref{valid:asymptotic} has a mixed local-analytic/numerical status.
...
{\cite[Theorem~9]{BHS25}} guarantees that near any closed
...
\item \emph{Convergence of the asymptotic expansion.}
  ...
  The expansion parameter satisfies $c_1/k < 1$ for all
  $k \geq 1$, and the truncated asymptotic expansion is numerically
  useful across the tested range, with rapid convergence for $k \geq 10$.
\end{enumerate}
...
\begin{equation}\label{eq:A2-formula}
  ...
  \;=\; 50.14645952466,
\end{equation}
with all factors evaluated at $\delta = 0$.  With the displayed constants,
this agrees with the Richardson value
$A^2 = 50.1464595246613\ldots$ to the shown digits.

\begin{remark}[Gauge invariance of $A^2/\Delta s$]\label{rem:gauge-invariant}
...
\subsection{Conformality on \texorpdfstring{$S^3$}{SÃ‚Â³}}\label{sec:conformality}
...
numerically, this provides the minimum $\abs{s_1}$ detected along the
tracked branch for the existence of a Bonnet pair at fold~$k$.
...
\paragraph{Root topology and cross-ratio layer (theorem-level and certificate-level).}
...
$-4.000$~rad at $k \geq 20$.  Numerically, the convergence is
compatible with a fit of the form
...
i.e.\ $\mathrm{CR}_k \approx \ee^{-4\ii/k}$ asymptotically.
  ...
  (cf.\ \cref{prop:arg-4}).  This higher-order fit is observational and
  is not used as theorem-level input.
\end{observation}
...
\paragraph{Barrier and monodromy remarks (remark-level).}
...
\paragraph{Spectral modulus, corrected lambda transform, and
  finite-data audit (conjecture-, conditional-, and audit-level).}
...
\end{equation}
supported numerically at the $6$-significant-digit level on $50$ archived
...
accounted for in \cref{cond:tau-univ} under the corrected
...
$50$ checked seeds in the range $k=5$ to $200$, a high-precision
...
\begin{enumerate}[label=\textup{(H\arabic*)},nosep,leftmargin=*]
\item\label{hyp:root-ordering}
  the mixed root topology and ordering $r_1=c$, $r_2=\bar c$,
  $r_3=a$, $r_4=b$ holds, established either asymptotically by
  \cref{thm:large-fold-root-topology}, from the exact finite
  certificates summarised in \cref{obs:root-type}, or from the
  interval-certificate hypotheses of
  \cref{prop:finite-root-topology-certificate};
\item\label{hyp:lambda-corrected}
  the corrected branch relation~\eqref{eq:lambda-CR-corrected} applies,
  namely $\mathrm{CR}_k = (1-\lambda(\tau_{\mathrm{spec}}(k)))^{-1}$;
\item\label{hyp:cusp-branch}
  the spectral modulus is taken in the high-cusp branch whose nome
  satisfies
  \[
    q_{\mathrm{spec}} = \ee^{\pi\ii\tau_{\mathrm{spec}}}
    \sim -\frac{\ii}{4k},
  \]
  so that, for $k$ large enough, $\tau_{\mathrm{spec}}$ lies in the
  local neighbourhood governed by
  \cref{lem:lambda-boundary-circle},
\end{enumerate}
for all sufficiently large fold numbers $k$ on that branch,
...
\begin{proof}
By~\ref{hyp:root-ordering}, the mixed root ordering gives
$\abs{\mathrm{CR}_k}=1$ by \cref{lem:CR-unit}.  Using the corrected
transform~\eqref{eq:lambda-CR-corrected} from~\ref{hyp:lambda-corrected}, this is equivalent to
\[
  \abs{1-\lambda(\tau_{\mathrm{spec}}(k))}=1.
\]
The nome condition $q_{\mathrm{spec}}\sim-\ii/(4k)$
from~\ref{hyp:cusp-branch} selects the cusp component with
$\Real\tau$ near $-\tfrac12$.  The local uniqueness
...
across the tested range; \cref{valid:asymptotic}), so the
cancellation in the cross-ratio is strong numerical evidence for a
structural property.
\end{observation}
...
asymptotic expansion.  Numerically, a secondary empirical fit on the
tested spectral-period seeds is consistent with
...
This should be read only as a numerical refinement of the conjectural
leading term, not as a proved or independently certified higher-order
law.
\end{observation}
...
\cref{cond:tau-univ} once the corrected anharmonic transform between
...
\item formulated the conjectural spectral-modulus relation
  ...
  a finite-data audit on $50$ archived spectral-period seeds in the
...
\item \textbf{Higher-order remainder and the $c_3$ term.}
  ...
  (\cref{obs:rigorous-asymp}).  Extending the formal
...
\item \textbf{Bridge PVI to $k$-fold periodicity.}
  ...
  accounted for conditionally in \cref{cond:tau-univ}.
...
\item \textbf{Gauge dependence of $A$.}
  ...
  the identity (\cref{rem:gauge-invariant}): $\tilde Q_2(s_2)$ depends
...
\item \path{results/phase15_asymptotic/critical_recheck/}:
  residual re-solve audit for the $48$ rows of the archived
  $998$-seed branch file with residual above $10^{-10}$,
\item \path{data/high_precision_checkpoints.json}:
  archived $120$-seed high-precision checkpoint set used for the
  Richardson extrapolation and the finite checkpoint validation in
  \cref{valid:asymptotic,obs:rigorous-asymp},
...
\item \path{results/B4/high_precision/B4_full_precision_seed_data_kle200.csv}
  ...
  the verified $50$-seed subset in the range $k=5$ to $200$,
...
\noindent\textbf{Repository revision.}
The numerical artifacts, figures, and tables quoted in this version of
the manuscript were produced at repository revision
\texttt{af6800542e1e46b77bdd1ac1fe826d2dce974ac0} (short hash
\texttt{af68005}), corresponding to the post-audit close-out of
2026-04-22.  The SHA is mirrored in \path{REPRODUCE.md} and in
\path{CHANGELOG.md}.
...
\section{Formal asymptotics for \texorpdfstring{$\delta = A/\!\sqrt{k}$}{ÃŽÂ´=A/Ã¢Ë†Å¡k}}%
\label{app:rigorous}
...
(\cref{rem:gauge-invariant}) follows from
$P\,s_2^2 - 2M\,s_2$
$= U^{-2}(2U_1' s_2^3 - U_2 s_2^2 - 2U' s_2)$.

\smallskip
At $\delta = 0$ with $s_2 = s_{2,\infty}$ (equivalently, at the
$k\to\infty$ axial limit of the tested branch, where $C_2 =
s_{2,\infty}\approx 7.29962$):
...
\newblock \emph{Int.\ Math.\ Res.\ Not.\ IMRN}, 2025(24):rnaf349.
\newblock DOI: 10.1093/imrn/rnaf349.
