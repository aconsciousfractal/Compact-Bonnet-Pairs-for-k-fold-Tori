...
Phase 17.1–17.2–17.6: Moduli space analysis from the archived s1 sweep.
...
Writes: data/moduli_analysis.json
        data/moduli_curves.png
        data/branch_convergence_k7.png
"""
