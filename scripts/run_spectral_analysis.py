...
Reads: results/phase11_higher_fold/lemma9_sweep.json
       results/phase15_asymptotic/full_series_k10_50.json
Writes: results/phase17_moduli/phase17_345_results.json
        results/phase17_moduli/curvature_curves.png
        results/phase17_moduli/interfold_section.png
        results/phase17_moduli/jacobian_analysis.png
"""
