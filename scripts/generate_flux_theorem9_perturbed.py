"""
Generate a perturbative Bonnet example (Theorem 9) as Flux-style OBJ output.

Outputs:
  - f_plus.obj
  - f_minus.obj
  - material.mtl
  - flux.obj   (wireframe / flux edges)
  - metadata.json

Default example:
  3-fold Theorem 7 seed + first perturbative Theorem 9 correction.
"""
...
NAME = "bonnet_theorem9_perturbed_3fold"
...
def main() -> None:
    print("=" * 70)
    print("  BONNET THEOREM 9 PERTURBATIVE FLUX EXPORT")
    print("=" * 70)
    ...
    # Blue-violet family for perturbative example; minus branch slightly shifted.
    ...
    kd_plus = (0.24, 0.46, 0.82)
    kd_minus = (0.46, 0.28, 0.74)
    ...
    write_mtl(
        ...
        ks=(0.35, 0.30, 0.25),
        ns=80.0,
        comment="Theorem 9 perturbative Bonnet example",
    )
    with mtl_path.open("a", encoding="utf-8") as f:
        f.write(f"\nnewmtl {NAME}_minus\n")
        f.write(f"Ka 0.0300 0.0300 0.0300\n")
    ...
    write_flux_wireframe_obj(
        ...
        header=header + ["Flux wireframe: perturbative example"],
    )
